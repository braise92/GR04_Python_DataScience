...
def train_and_evaluate_models(X, y):
    ...
    # Grilles d'hyperparamètres raisonnables (à ajuster si besoin)
    rf_param_grid = {
        "n_estimators": [50, 100],
        "max_depth": [3, 5, 10],
...
def main():
    parser = argparse.ArgumentParser(description="Classification boursière automatisée avec optimisation d'hyperparamètres")
    parser.add_argument('--folder', type=str, default="Companies_Historical_Data",
                        help="Chemin vers le dossier contenant les fichiers CSV des entreprises")
